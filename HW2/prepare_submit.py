...
required_files = {'bert.py', 'optimizer.py', 'classifier.py', 'sst-dev-output.txt', 'sst-test-output.txt', 'cfimdb-dev-output.txt', 'cfimdb-test-output.txt', 'AdamOptimizerAsPaper.py', 'tune_run.sh', 'output.log'}
